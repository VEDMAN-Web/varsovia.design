...
import type { FooterNavLink } from "@/lib/footerNavigationTypes";
...
function FooterNavLink({ href, label }: { href: string; label: string }) {
  ...
  const className = `group relative font-outfit text-[14px] leading-snug transition-colors duration-200 sm:text-[16px] lg:text-[18px] lg:leading-normal ${
...
function FooterLegalLink({ link }: { link: FooterNavLink }) {
  ...
  const className =
    ...
    "inline-flex items-center font-outfit text-[11px] font-light leading-none text-white/60 transition-colors duration-200 hover:text-white sm:text-[12px]";
        ...
        <div className="flex flex-col gap-8 sm:gap-10 lg:flex-row lg:gap-[128px] lg:gap-y-12">
          ...
          <div className="grid min-w-0 flex-1 grid-cols-2 gap-x-6 gap-y-8 sm:gap-x-10 lg:flex lg:flex-row lg:flex-nowrap lg:gap-[80px] xl:gap-[120px] lg:pt-[31px]">
            ...
            {footerNav.linkColumns.map((column) => (
              ...
              <nav key={column.id} className="flex flex-col gap-2 sm:gap-3 lg:gap-4">
        ...
        <div className="mt-8 border-t border-white/20 pt-3 pb-2 sm:mt-10 sm:pt-[10px] lg:mt-[clamp(2.5rem,6vw,5rem)]">
          ...
          <div className="flex flex-wrap items-center gap-y-1.5">
            ...
            {footerNav.legalLinks.map((link, index) => (
              ...
              <span key={`${link.href}-${index}`} className="inline-flex items-center">
