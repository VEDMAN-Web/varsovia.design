...
export const CONTACT_LABEL =
  "font-outfit mb-[7px] block pl-4 text-[18px] font-medium leading-[23px] text-[#6a414d]";
...
export const MODAL_LABEL =
  "font-outfit mb-[6px] block text-[18px] font-medium leading-[21px] text-[#6a414d]";
export const MODAL_FIELD =
  "font-outfit h-[46px] w-full rounded-[6px] bg-[#e5c9cd] px-[15px] text-[14px] leading-normal text-[#251b1e] outline-none placeholder:text-[rgba(37,27,30,0.6)]";
export const MODAL_FIELD_ROW = "grid grid-cols-1 gap-[10px] sm:grid-cols-2";
export const MODAL_FORM_GAP = "flex flex-col gap-[14px]";
