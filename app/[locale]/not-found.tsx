...
export default async function NotFound() {
  ...
  return (
    <div className="flex min-h-[70vh] flex-col items-center justify-center bg-[#fdf2f0] px-6 text-center">
      ...
      <h1 className="mt-4 font-display text-3xl font-semibold text-[#6a414d] md:text-4xl">{t("notFoundTitle")}</h1>
      <p className="mt-4 max-w-md text-sm leading-relaxed text-[#6a414d]/80">{t("notFoundMessage")}</p>
      <Link
        href="/"
